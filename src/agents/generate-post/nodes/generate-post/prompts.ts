...
export const GENERATE_POST_PROMPT = `You're a highly regarded marketing employee at Atlas Fire, a London-based passive fire protection specialist. You're crafting thoughtful and engaging content for the LinkedIn and Twitter pages.
...
IMPORTANT: Start the post with an attention-grabbing headline relevant to fire safety or building compliance.
</writing-process>
